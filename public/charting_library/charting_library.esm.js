...
function o(t, e) {
  const n = new URL(`${t || ""}`, location.href).href,
    o = JSON.parse(
      '["bundles/runtime.07b91e827a9e2e00f3e6.js","bundles/__LANG__.8113.6effbc8b6375d6a16597.js","bundles/7717.8f75bd75d4b6ed45f3ff.css","bundles/7717.8f75bd75d4b6ed45f3ff.rtl.css","bundles/4618.1f26befe6bcf2274cd1a.js","bundles/library.37165260d08a007f8938.js","bundles/EuclidCircular.be8f862db48c2976009f.woff2"]'
    ),
    s = JSON.parse(
    ...
    l = `\n${(function (t, e, n) {
      ...
      for (const l of t)
        l.endsWith(".js")
          ? s.push(
              `<script defer crossorigin="anonymous" src="${l.replace(
                "__LANG__",
                n
              )}"><\/script>`
            )
...
function s() {
  return "CL v24.000 (internal id b7d8dd93 @ 2023-02-14T12:17:58.891Z)";
}
const r = class {
  constructor(i) {
    var o;
    ...
    (null === (o = i.overrides) || void 0 === o
      ...
      delete i.overrides["mainSeriesProperties.priceAxisProperties.lockScale"]),
      (this._options = t(e, i)),
      ...
      this._options.debug &&
        (n ||
          ((n = !0),
          console.log(
            "Using CL v24.000 (internal id b7d8dd93 @ 2023-02-14T12:17:58.891Z)"
          ))),
      this._create();
  }
  setDebugMode(t) {
  ...
  _render() {
    ...
    const e = o(this._options.library_path || "", this._options.locale),
...
export { s as version, r as widget };
