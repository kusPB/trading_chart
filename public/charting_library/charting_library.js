!(function (t, e) {
  ...
  function o(t) {
    ...
    return `<link rel="preload" href="${t}" as="font" type="font/woff${null !== (e = null == n ? void 0 : n[1]) && void 0 !== e ? e : "2"}" crossorigin="anonymous"/>`;
  }
  function s(t, e) {
  ...
  const a = class {
    ...
    _render() {
      ...
      const e = s(this._options.library_path || "", this._options.locale),
